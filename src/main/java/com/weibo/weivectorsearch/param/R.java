...
import com.weibo.weivectorsearch.exception.VectorSearchException;
import com.weibo.weivectorsearch.rpc.ErrorCode;
...
public class R<T> {
    ...
    public static <T> R<T> failed(Exception exception) {
        R<T> r = new R<>();
        if (exception instanceof VectorSearchException) {
            VectorSearchException e = (VectorSearchException) exception;
